...
namespace _Scripts.Managers
{
    ...
    public class OptionsManager : MonoBehaviour
    {
        ...
        public void SetBGMVolume(float value)
        {
            ...
            SingletonPoint.Instance.AudioManager.SetBGMVolume(BGMVolume);
        ...
        public void SetSFXVolume(float value)
        {
            ...
            SingletonPoint.Instance.AudioManager.SetSFXVolume(SFXVolume);
        ...
        {
            if (!difficultyProgression || difficultyProgression.thresholds == null) return;
        ...
        {
            if (!DifficultyManager.Instance || !difficultyProgression) return;
